...
- [ ] Document queue/topic and scheduler impacts.
- [ ] Document idempotency, retry, and dead-letter behavior.
- [ ] Attach runbook updates and on-call notes.
- [ ] Attach staged rollout and backout plan.
