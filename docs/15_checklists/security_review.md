...
- [ ] Review identity/authz changes (OIDC, RBAC, ABAC).
- [ ] Review data handling for PII, encryption, and auditability.
- [ ] Review secrets rotation and runtime hardening updates.
- [ ] Review threat model updates and residual risks.
