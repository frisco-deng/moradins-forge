...
- [ ] Document query parsing, retrieval fusion, or rerank impact.
- [ ] Update evaluation thresholds and expected quality deltas.
- [ ] Validate policy filtering and provenance behavior.
- [ ] Capture online safety guardrails and rollback strategy.
