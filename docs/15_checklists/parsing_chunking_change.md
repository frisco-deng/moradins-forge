...
- [ ] Document parser or chunking algorithm revision and rationale.
- [ ] Run regression fixtures for chunk boundaries and metadata carryover.
- [ ] Record downstream indexing and retrieval impact.
- [ ] Update rollback and feature-flag controls.
