...
- [ ] Record incident start time, affected surfaces, and severity.
- [ ] Apply runbook diagnostics and mitigation sequence.
- [ ] Document customer/data impact and communication steps.
- [ ] Record root cause, corrective actions, and follow-up gates.
